    ...
    () => [
      {
        ...
        Cell: ({ cell }) => (
          <Typography
            ...
            onClick={() => navigate(`/stock-transfer-entry/${cell.row.original.InvNo}`)}
          >
            {cell.getValue()}
          </Typography>
        ),
            ...
            renderRowActions={({ row }) => (
              <Box sx={{ display: 'flex', gap: 1 }}>
                {/* <Tooltip title="View">
                  <IconButton
                    size="small"
                    onClick={() => navigate(`/stock-transfer-entry/${row.original.id}`)}
                    sx={{
                ...
                <Tooltip title="Edit">
                  <IconButton
                    size="small"
                    onClick={() => navigate(`/stock-transfer-entry/${row.original.InvNo}`)}
                    sx={{
            ...
            renderTopToolbarCustomActions={() => (
              <Stack direction="row" spacing={2}>
                <Button
                  variant="contained"
                  startIcon={<AddIcon />}
                  onClick={() => navigate('/stock-transfer-entry')}
                  sx={{
